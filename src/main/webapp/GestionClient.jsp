        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="GestionSalle.jsp">Salles</a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#form-elements" aria-expanded="false" aria-controls="form-elements">
              ...
              <span class="menu-title">Gestion Créneaux </span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="pages/forms/basic_elements.html">Créneaux horaires</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="GestionClient.jsp">Clients</a></li>
              </ul>
            </div>
          </li>
      ...
      <div class="main-panel">
                ...
                <div class="card-body">
                  <h3 class="card-title">Gestion des Clients</h3>
                  							...
                  							<form action="ClientController" method="POST" role="form"
								class="text-start">
								<div class="input-group input-group-outline my-3">
									<label hidden class="form-label">Type</label> <input type="hidden" id="id" name="id"
										type="text" class="form-control"  >
								</div>
								<div class="input-group input-group-outline my-3">
									<label class="form-label">Nom</label> <input id="nom"
										type="text" class="form-control" name="nom" >
								</div>
								<div class="input-group input-group-outline mb-3">
									<label class="form-label">Prenom</label> <input id="prenom"
								...
								<div id="modifier" class="text-center">
									<button style="display: none" type="button" id="update"
